...
import com.epam.constants.UmladdonConstants;



/**
 * This is the extension manager of the Umladdon extension.
 */
public class UmladdonManager extends GeneratedUmladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UmladdonManager.class.getName());
	 ...
	 */
	public static UmladdonManager getInstance()
	{
		return (UmladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				UmladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UmladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UmladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of UmladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of UmladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
